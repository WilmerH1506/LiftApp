...
class Sumo extends StatelessWidget {
    const Sumo({Key? key}) : super(key: key);
    ...
    return MaterialApp(
      home: Scaffold( backgroundColor: Colors.black,
        appBar: AppBar(
          title: const Row(
            children: [
               Text('Sentadilla Sumo',style: TextStyle(
            color: Colors.black,
        ...
        child: Column(
          children: [ 
            ...
            child: Container(
             ...
             child: FutureBuilder<Widget>(
                                        future: AggGif('Videos/SUMO.gif').getGifWidget(),
         ...
         const Row(
           ...
           const  Row(
              children: [
                SizedBox(width: 10,),
            Text('Primario: Gluteos',style: TextStyle(
              color: Colors.white,
              fontWeight: FontWeight.bold,
              fontSize: 17
            ),),
          ...
          const  Row(
              children: [
                SizedBox(width: 10,),
            Text('Secundario: Femoral, Cuadriceps',style: TextStyle(
              color: Colors.white,
               ...
               const  SizedBox(height: 40,),
                ElevatedButton(
                            onPressed: () {
                              ...
                              subir.bsdTemporal(user, 'Sentadilla Sumo', name);
