...
class Zancadas extends StatelessWidget {
    const Zancadas({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [ 
            ...
            child: Container(
             ...
             child: FutureBuilder<Widget>(
                                        future: AggGif('Videos/zancadas.gif').getGifWidget(),
         ...
         const Row(
           ...
           const  Row(
              children: [
                SizedBox(width: 10,),
            Text('Primario: Cuadricep',style: TextStyle(
              color: Colors.white,
              fontWeight: FontWeight.bold,
              fontSize: 17
            ),),
              ...
              const Row(
               ...
               ElevatedButton(
                            onPressed: () {
                              ...
                              subir.bsdTemporal(user, 'Zancadas', name);
