        ...
        child: Column(
          children: [ 
            ...
            child: Container(
             ...
             child: FutureBuilder<Widget>(
                                        future: AggGif('Videos/Prensa.gif').getGifWidget(),
         ...
         const Row(
          ...
          const  Row(
              children: [
                SizedBox(width: 10,),
            Text('Secundario: Femoral, Gluteo',style: TextStyle(
              color: Colors.white,
              ...
              const Row(
               ...
               ElevatedButton(
                            onPressed: () {
                              ...
                              subir.bsdTemporal(user, 'Prensa', name);
