...
class Extensiones extends StatelessWidget {
    const Extensiones({Key? key}) : super(key: key);
    ...
    return MaterialApp(
      home: Scaffold( backgroundColor: Colors.black,
        appBar: AppBar(
          title: const Row(
            children: [
               Text('Extensiones',style: TextStyle(
            color: Colors.black,
          ...
          children: [ 
            ...
            child: Container(
             ...
             child: FutureBuilder<Widget>(
                                        future: AggGif('Videos/extensiones.gif').getGifWidget(),
               ...
               const  SizedBox(height: 40,),
                ElevatedButton(
                            onPressed: () {
                              ...
                              subir.bsdTemporal(user, 'Extensiones',name);
