...
class Abductores extends StatelessWidget {
    const Abductores({Key? key}) : super(key: key);
    ...
    return MaterialApp(
      home: Scaffold( backgroundColor: Colors.black,
        appBar: AppBar(
          title: const Row(
            children: [
               Text('Abductores',style: TextStyle(
            color: Colors.black,
        ...
        child: Column(
          children: [ 
            ...
            child: Container(
             ...
             child: FutureBuilder<Widget>(
                                        future: AggGif('Videos/abductor.gif').getGifWidget(),
         ...
         const Row(
           ...
           const  Row(
              children: [
                SizedBox(width: 10,),
            Text('Primario: Abductor',style: TextStyle(
              color: Colors.white,
              fontWeight: FontWeight.bold,
              fontSize: 17
            ),),
          ...
          const  Row(
              children: [
                SizedBox(width: 10,),
            Text('Secundario: Gluteo',style: TextStyle(
              color: Colors.white,
               ...
               const  SizedBox(height: 40,),
                 ElevatedButton(
                            onPressed: () {
                              ...
                              subir.bsdTemporal(user, 'Abductores', name);
