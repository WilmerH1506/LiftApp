...
class ElevacionesSentado extends StatelessWidget {
    const ElevacionesSentado({Key? key}) : super(key: key);
    ...
    return MaterialApp(
      home: Scaffold( backgroundColor: Colors.black,
        appBar: AppBar(
          title: const Row(
            children: [
               Text('Elevaciones Sentado',style: TextStyle(
            color: Colors.black,
        ...
        child: Column(
          children: [ 
            ...
            child: Container(
             ...
             child: FutureBuilder<Widget>(
                                        future: AggGif('Videos/descarga.gif').getGifWidget(),
         ...
         const Row(
           ...
           const  Row(
              children: [
                SizedBox(width: 10,),
            Text('Primario: Pantorilla',style: TextStyle(
              color: Colors.white,
              fontWeight: FontWeight.bold,
              fontSize: 17
            ),),
               ...
               const  SizedBox(height: 40,),
                 ElevatedButton(
                            onPressed: () {
                              ...
                              subir.bsdTemporal(user, 'Pantorrillas Parado', name);
