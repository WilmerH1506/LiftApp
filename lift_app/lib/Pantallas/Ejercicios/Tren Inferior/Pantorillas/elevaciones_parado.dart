...
class ElevacionesParado extends StatelessWidget {
    const ElevacionesParado({Key? key}) : super(key: key);
    ...
    return MaterialApp(
      home: Scaffold( backgroundColor: Colors.black,
        appBar: AppBar(
          title: const Row(
            children: [
               Text('Elevaciones De Pie',style: TextStyle(
            color: Colors.black,
          ...
          children: [ 
            ...
            child: Container(
             ...
             child: FutureBuilder<Widget>(
                                        future: AggGif('Videos/pantorilla.gif').getGifWidget(),
