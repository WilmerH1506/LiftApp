...
class ExtensionBarra extends StatelessWidget {
    const ExtensionBarra({Key? key}) : super(key: key);
    ...
    return MaterialApp(
      home: Scaffold( backgroundColor: Colors.black,
        appBar: AppBar(
          title: const Row(
            children: [
               Text('Extensiones Con Barra',style: TextStyle(
            color: Colors.black,
          ...
          children: [ 
            ...
            child: Container(
             ...
             child: FutureBuilder<Widget>(
                                        future: AggGif('Videos/tricep con barra.gif').getGifWidget(),
               ...
               const  SizedBox(height: 40,),
                ElevatedButton(
                            onPressed: () {
                              ...
                              subir.bsdTemporal(user, 'Extension con Barra', name);
