...
class ExtensionPolea extends StatelessWidget {
    const ExtensionPolea({Key? key}) : super(key: key);
    ...
    return MaterialApp(
      home: Scaffold( backgroundColor: Colors.black,
        appBar: AppBar(
          title: const Row(
            children: [
               Text('Extensiones Con Polea',style: TextStyle(
            color: Colors.black,
        ...
        child: Column(
          children: [ 
            ...
            child: Container(
             ...
             child: FutureBuilder<Widget>(
                                        future: AggGif('Videos/cable-tricep-pushdown.gif').getGifWidget(),
         ...
         const Row(
           ...
           const  Row(
              children: [
                SizedBox(width: 10,),
            Text('Primario: Cabeza Lateral Tricep',style: TextStyle(
              color: Colors.white,
              fontWeight: FontWeight.bold,
              fontSize: 17
            ),),
               ...
               const  SizedBox(height: 40,),
                ElevatedButton(
                            onPressed: () {
                              ...
                              subir.bsdTemporal(user, 'Extension polea', name);
