...
class Fondos extends StatelessWidget {
    const Fondos({Key? key}) : super(key: key);
                        ...
                        Padding(
                            ...
                            child: Container(
                                ...
                                child: FutureBuilder<Widget>(
                                    future: AggGif('Videos/bench-dips-on-floor.gif').getGifWidget(),
                        ...
                        if (!showAddButton)
                            ElevatedButton(
                                onPressed: () {
                                    ...
                                    subir.bsdTemporal(user, 'Fondos', name);
