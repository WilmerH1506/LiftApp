...
class PressInclinado extends StatelessWidget {
    const PressInclinado({Key? key}) : super(key: key);
    ...
    return MaterialApp(
      home: Scaffold( backgroundColor: Colors.black,
        appBar: AppBar(
          title: const Row(
            children: [
               Text('Press Inclinado',style: TextStyle(
            color: Colors.black,
        ...
        child: Column(
          children: [ 
            ...
            child: Container(
             ...
             child: FutureBuilder<Widget>(
                                        future: AggGif('Videos/press inclinado.gif').getGifWidget(),
         ...
         const Row(
           ...
           const  Row(
              children: [
                SizedBox(width: 10,),
            Text('Primario: Parte Alta Del Pecho',style: TextStyle(
              color: Colors.white,
              fontWeight: FontWeight.bold,
              fontSize: 17
            ),),
          ...
          const  Row(
              children: [
                SizedBox(width: 10,),
            Text('Secundario: Triceps, Hombro Frontal',style: TextStyle(
              color: Colors.white,
               ...
               const  SizedBox(height: 40,),
                ElevatedButton(
                            onPressed: () {
                              ...
                              subir.bsdTemporal(user, 'Pecho Superior', name);
