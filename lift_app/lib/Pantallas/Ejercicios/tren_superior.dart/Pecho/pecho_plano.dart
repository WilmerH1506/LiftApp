...
class PressPlano extends StatelessWidget {
    const PressPlano({Key? key}) : super(key: key);
    ...
    return MaterialApp(
      home: Scaffold( backgroundColor: Colors.black,
        appBar: AppBar(
          title: const Row(
            children: [
               Text('Press Plano',style: TextStyle(
            color: Colors.black,
        ...
        child: Column(
          children: [ 
            ...
            child: Container(
             ...
             child: FutureBuilder<Widget>(
                                        future: AggGif('Videos/barbell-bench-press.gif').getGifWidget(),
         ...
         const Row(
           ...
           const  Row(
              children: [
                SizedBox(width: 10,),
            Text('Primario: Parte Media Del Pecho',style: TextStyle(
              color: Colors.white,
              fontWeight: FontWeight.bold,
              fontSize: 17
            ),),
               ...
               const  SizedBox(height: 40,),
                 ElevatedButton(
                            onPressed: () {
                              ...
                              subir.bsdTemporal(user, 'Pecho Plano', name);
