...
class Antebrazo extends StatelessWidget {
    const Antebrazo({Key? key}) : super(key: key);
    ...
    return MaterialApp(
      home: Scaffold( backgroundColor: Colors.black,
        appBar: AppBar(
          title: const Row(
            children: [
               Text('Antebrazo',style: TextStyle(
            color: Colors.black,
        ...
        child: Column(
          children: [ 
            ...
            child: Container(
             ...
             child: FutureBuilder<Widget>(
                                        future: AggGif('Videos/antebrazos.gif').getGifWidget(),
         ...
         const Row(
           ...
           const  Row(
              children: [
                SizedBox(width: 10,),
            Text('Primario: Antebrazo',style: TextStyle(
              color: Colors.white,
              fontWeight: FontWeight.bold,
              fontSize: 17
            ),),
          ...
          const  Row(
              children: [
                SizedBox(width: 10,),
            Text('Secundario: Bicep Braquial',style: TextStyle(
              color: Colors.white,
               ...
               const  SizedBox(height: 40,),
                ElevatedButton(
                            onPressed: () {
                              ...
                              subir.bsdTemporal(user, 'Antebrazo', name);
