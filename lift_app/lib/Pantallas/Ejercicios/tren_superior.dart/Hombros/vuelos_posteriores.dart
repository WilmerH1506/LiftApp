...
class Posteriores extends StatelessWidget {
    const Posteriores({Key? key}) : super(key: key);
    ...
    return MaterialApp(
      home: Scaffold( backgroundColor: Colors.black,
        appBar: AppBar(
          title: const Row(
            children: [
               Text('Vuelos Posteriores',style: TextStyle(
            color: Colors.black,
        ...
        child: Column(
         ...
         const Row(
            children: [
            Text(' Press Militar',style: TextStyle(
              color: Colors.white,
              fontWeight: FontWeight.bold,
              fontSize: 25
            ),),
           ...
           const  Row(
              children: [
                SizedBox(width: 10,),
            Text('Primario: Hombro Posterior',style: TextStyle(
              color: Colors.white,
              fontWeight: FontWeight.bold,
              fontSize: 17
            ),),
               ...
               const  SizedBox(height: 40,),
                 ElevatedButton(
                            onPressed: () {
                              ...
                              subir.bsdTemporal(user, 'Vuelos Posteriores', name);
