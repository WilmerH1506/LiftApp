                    ...
                    children: [
                        Padding(
                            ...
                            child: Container(
                                ...
                                child: FutureBuilder<Widget>(
                                    future: AggGif('Videos/Face pulls.gif').getGifWidget(),
                        ...
                        const Row(
                            children: [
                                 SizedBox(width: 10),
                                Text(
                                    'Primario: Espalda Alta, Deltoides',
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontWeight: FontWeight.bold,
                                        fontSize: 17,
                        ...
                        const Row(
                            children: [
                                 SizedBox(width: 10),
                                Text(
                                    'Secundario: Braquial, Manguito Rotador',
                                    style: TextStyle(
                                        color: Colors.white,
                        ...
                        if (!showAddButton)
                            ElevatedButton(
                                onPressed: () {
                                    ...
                                    subir.bsdTemporal(user, 'Face Pulls', name);
