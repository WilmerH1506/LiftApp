...
class Remos extends StatelessWidget {
    const Remos({Key? key}) : super(key: key);
                    ...
                    children: [
                        Padding(
                            ...
                            child: Container(
                                ...
                                child: FutureBuilder<Widget>(
                                    future: AggGif('Videos/Remo Barra (2).gif').getGifWidget(),
                        ...
                        const Row(
                            children: [
                                SizedBox(width: 10),
                                Text(
                                    'Primario: Dorsales, Deltoides, Espalda Baja',
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontWeight: FontWeight.bold,
                                        fontSize: 17,
                        ...
                        const Row(
                            children: [
                                SizedBox(width: 10),
                                Text(
                                    'Secundario: Trapecio, Bíceps, Romboides',
                                    style: TextStyle(
                                        color: Colors.white,
                        ...
                        if (!arguments.containsKey('showAddButton') || !arguments['showAddButton'])
                            ElevatedButton(
                                onPressed: () {
                                    ...
                                    subir.bsdTemporal(user, 'Remos con Barra', name);
